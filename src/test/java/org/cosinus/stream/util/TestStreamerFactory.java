...
public class TestStreamerFactory {
    ...
    {
        try (InputStream input = TestStreamerFactory.class.getResourceAsStream(testResourcePath))
        {
            ObjectMapper objectMapper = new ObjectMapper();
            return objectMapper.readValue(input, JsonStreamSupplier.class);
        }
    }
}
